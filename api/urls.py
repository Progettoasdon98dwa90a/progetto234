...
from api.views.v2.schedules import get_branch_schedules, start_schedule
...
urlpatterns = [
    ...
    path('turni/createSchedule/<int:branch_id>/', get_branch_schedules, name='CREATE_SCHEDULE'),
